...
public class CommentDeleted implements EventHandlerType {
    private static final ELearningEventType EVENT_TYPE = ELearningEventType.COMMENT_DELETED;

    private MaterialService materialService;

	@Autowired
	public CommentDeleted(MaterialService materialService){
